...
class AnimalTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let animalCell =  cell as? AnimalTableViewCell{
            ...
            animalCell.nomeAnimalLabel.text = animal.nomeAnimal
            animalCell.especieAnimalLabel.text = animal.especieAnimal
            animalCell.nomeFotoAnimalImage.image = UIImage(named: animal.nomeFotoAnimal)
